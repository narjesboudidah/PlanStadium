...
use App\Models\permissionRolePivot;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;


class PermissionRolePivotController extends Controller
{
    /*Display a listing of the resource.*/
    public function index()
    {
        $permission_roles = permission_roleResource::collection(permissionRolePivot::get()); //ki tabda bech trajaa akther min 7aja
        $array = [
    ...
    {
        $permission_role = permissionRolePivot::find($id);
        if ($permission_role) {
            $array = [
    ...
    public function store(Request $request)
    {
        ...
        $permission_role = permissionRolePivot::create($request->all());
        if ($permission_role) {
            $array = [
                'data' => new permission_roleResource($permission_role),
